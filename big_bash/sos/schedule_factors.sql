...
drop table if exists big_bash._schedule_factors;

create table big_bash._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
...
insert into big_bash._schedule_factors
(team_id,offensive,defensive)
(
select o.level,o.exp_factor,d.exp_factor
from big_bash._factors o
left outer join big_bash._factors d
  on (d.level,d.parameter)=(o.level,'defense')
where o.parameter='offense'
);

update big_bash._schedule_factors
...
strength=o.strength
from big_bash._schedule_factors o
