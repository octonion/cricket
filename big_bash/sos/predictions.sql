...
from big_bash.games g
join big_bash._schedule_factors sf1
  on (sf1.team_id)=(g.home_team)
join big_bash._schedule_factors sf2
  on (sf2.team_id)=(g.away_team)

join big_bash._factors o
  on (o.parameter,o.level)=('field','offense_home')
join big_bash._factors d
  on (d.parameter,d.level)=('field','defense_home')

join big_bash._basic_factors i
