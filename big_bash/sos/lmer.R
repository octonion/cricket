...
dbWriteTable(con,c("big_bash","_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("big_bash","_basic_factors"),as.data.frame(combined),row.names=TRUE)
