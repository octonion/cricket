...
drop table if exists ipl._schedule_factors;

create table ipl._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
