...
drop table if exists super_smash._schedule_factors;

create table super_smash._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
...
insert into super_smash._schedule_factors
(team_id,offensive,defensive)
(
select o.level,o.exp_factor,d.exp_factor
from super_smash._factors o
left outer join super_smash._factors d
  on (d.level,d.parameter)=(o.level,'defense')
where o.parameter='offense'
);

update super_smash._schedule_factors
...
strength=o.strength
from super_smash._schedule_factors o
